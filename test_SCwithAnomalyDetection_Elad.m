...
% K-SVD with GLSP
[DGLSP, DGLSP_hist, coefGLSP_hist, GLSP_coef_hist, GLSP_supp_hist] = K_SVD(true, dltrainset, D0, iter, L);
...
% K-SVD with OMP
[DOMP, DOMP_hist, coefOMP_hist, ~, ~] = K_SVD(false, dltrainset, D0, iter, L);
clear param
param.L  = 4;
